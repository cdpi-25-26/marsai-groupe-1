    ...
    <div className="min-h-screen bg-background text-foreground pb-32 font-['Arimo']">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 pt-32 md:pt-40">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-2 tracking-tight">13 JUIN 2026</h1>
          <h2 className="text-3xl md:text-4xl font-black text-purple-500 mb-8">MARSEILLE</h2>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-8 border-b-2 border-purple-500/30 pb-4">
          ...
          <div className="space-y-4">
            {conferences.map((event, idx) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[24px] p-6 flex items-center gap-8 group-hover:bg-white/10 transition-all duration-300">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h4 className="text-lg font-bold leading-tight text-white/90">{event.title}</h4>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        {/* Accès */}
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-8 border-b-2 border-[#51A2FF]/30 pb-4">
          ...
          <div className="aspect-video w-full rounded-[32px] overflow-hidden border border-white/10 relative group">
            <img
              src={imgMap}
              alt="Carte d'accès La Plateforme Marseille"
        ...
        {/* Ateliers pratiques */}
        <section>
          <div className="flex items-center gap-3 mb-8 border-b-2 border-pink-500/50 pb-4">
